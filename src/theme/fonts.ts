import type { UnionConfiguration } from './types/config';
import type { FontColors, FontSizes } from './types/fonts';
import type { TextStyle } from 'react-native';

import { config } from './_config';
import { responsiveFontSize } from '../utilities/responsiveSize';
